function steadyStatePenalty = pen_devSSdist_yeast(fluxMatrix)
    steadyStateProfiles = load('steadyStateProfiles_hynne.mat');
    steadyStateFluxes = steadyStateProfiles.ssFluxProfile_hynne;
