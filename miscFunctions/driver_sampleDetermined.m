...
load('GenData/data/Determined_k-01_hiRes.mat');
...
[penalty_gs,massbalance_penalty_gs,conc_penalty_gs,oneContMetCorr_penalty_gs,oneContMetCurveFit_penalty_gs,BST_penalty_gs,~,~] = calcPenalty_Determined(gs_RF,modelInfo,relative_Vpool,numMetabs,...
...
for rep = 1:10000
    ...
    [penalty,massbalance_penalty,conc_penalty,oneContMetCorr_penalty,oneContMetCurveFit_penalty,BST_penalty] ...
        = calcPenalty_Determined(testRF,modelInfo,relative_Vpool,numMetabs,...
            numFlux,MA_reactions,relative_concMatrix,timeVec,fluxTimeVec,RF_kinetics,...
            knownMet,knownKinetics);
...
save('Determined_sampling_final.mat');