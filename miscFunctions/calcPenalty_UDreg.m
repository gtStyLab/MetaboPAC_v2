function [penalty,massbalance_penalty,conc_penalty,oneContMetCorr_penalty,oneContMetCurveFit_penalty,BST_penalty,ss_penalty,Vcalc_pool,Vcalc] = calcPenalty_UDreg(testRF,modelInfo,relative_Vpool,numMetabs,numFlux,~,relative_concMatrix,timeVec,fluxTimeVec,RF_kinetics,knownMet,knownKinetics)
