...
modelInfo_UDreg
load('GenData/data/UDreg_k-01_hiRes.mat');
...
[penalty_gs,massbalance_penalty_gs,conc_penalty_gs,oneContMetCorr_penalty_gs,oneContMetCurveFit_penalty_gs,BST_penalty_gs,ss_penalty_gs,~,~] = calcPenalty_UDreg(gs_RF,modelInfo,relative_Vpool,numMetabs,...
...
[penalty,massbalance_penalty,conc_penalty,oneContMetCorr_penalty,oneContMetCurveFit_penalty,BST_penalty,ss_penalty] ...
    = calcPenalty_UDreg(testRF,modelInfo,relative_Vpool,numMetabs,...
        numFlux,MA_reactions,relative_concMatrix,timeVec,fluxTimeVec,RF_kinetics,...
        knownMet,knownKinetics);
