...
modelInfo_hynne
load('GenData/data/hynne_k-01_hiRes.mat');
...
%Assume known kinetics for accurate flux estimation
knownMet = [];
...
[penalty_gs,massbalance_penalty_gs,conc_penalty_gs,oneContMetCorr_penalty_gs,oneContMetCurveFit_penalty_gs,BST_penalty_gs,ss_penalty_gs,~,~] = calcPenalty_yeast(gs_RF,modelInfo,relative_Vpool,numMetabs,...
...
[penalty,massbalance_penalty,conc_penalty,oneContMetCorr_penalty,oneContMetCurveFit_penalty,BST_penalty,ss_penalty] ...
    = calcPenalty_yeast(testRF,modelInfo,relative_Vpool,numMetabs,...
        numFlux,MA_reactions,relative_concMatrix,timeVec,fluxTimeVec,RF_kinetics,...
        knownMet,knownKinetics);
