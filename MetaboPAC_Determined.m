function [absolute_concMatrix predicted_responseFactors] = MetaboPAC_Determined(approach_option,rep,percKnownKinetics,rand_idx)
...
save(sprintf('results/Determined_MetaboPAC_%spercKnownKinetics-%03d_rep-%03d_rand-%03d.mat',approach_string,percKnownKinetics,rep,rand_idx));
end
