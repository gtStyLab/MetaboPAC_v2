            ...
            for RFrep =  1:1:3
                for noise_rep = 1:1:3
                    for rand_idx = 1:1:3
                            ...
                            fileName = sprintf('results/UDreg_MetaboPAC_nT-%03d_cov-%02d_addKinetics-%03d_RFrep-%03d_noiserep-%03d_rand-%03d.mat',nt,cov,percKnownFlux,RFrep,noise_rep,rand_idx);
